# penguins_exploratorio guide installation
...
activate penguins_exploratorio
```
...
To move beyond notebook prototyping, all reusable code should go into the `penguins_exploratorio/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `penguins_exploratorio` folder and use the modules inside your notebooks :
...
```python
from penguins_exploratorio.utils.paths import data_dir
data_dir()
```
